...
import { ChevronDown, TrendingUp, Minus, BarChart3, LineChart, GitBranch } from 'lucide-react'
import Image from 'next/image'
import { Badge } from '@/components/ui/badge'

const bricks = [
  { icon: TrendingUp, label: 'Support' },
  { icon: Minus, label: 'Resistance' },
  { icon: GitBranch, label: 'Structure' },
  { icon: LineChart, label: 'EMAs' },
  { icon: BarChart3, label: 'Integration' },
]
...
export default function Day2Hero() {
  return (
    <section className="relative w-full min-h-[85vh] md:min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src="/hero-day2.png"
          alt="Technical Analysis - Reading the Language of Price"
          fill
      ...
      >
        ...
        >
          Support/Resistance, Trends & Moving Averages
        </motion.p>
        ...
        <motion.div variants={itemVariants} className="mb-6 sm:mb-8">
          ...
          >
            Reading the Language of Price &nbsp;|&nbsp; 8-Hour Intensive
          </Badge>
        </motion.div>
        ...
        >
          &ldquo;The chart is already telling you a story. Learn to read it.&rdquo;
        </motion.p>
