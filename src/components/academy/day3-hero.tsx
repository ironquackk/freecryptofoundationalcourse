...
import { ChevronDown, CandlestickChart, Activity, BarChart3, Volume2, CircleDot } from 'lucide-react'
import Image from 'next/image'
import { Badge } from '@/components/ui/badge'

const bricks = [
  { icon: CandlestickChart, label: 'Candlesticks' },
  { icon: Activity, label: 'RSI' },
  { icon: BarChart3, label: 'MACD' },
  { icon: Volume2, label: 'Volume' },
  { icon: CircleDot, label: 'Bollinger Bands' },
]
...
export default function Day3Hero() {
  return (
    <section className="relative w-full min-h-[85vh] md:min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <Image
          src="/hero-day3.png"
          alt="Price Action & Technical Indicators - Reading the Market Pulse"
          fill
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-6 sm:mb-8">
          ...
          >
            Indicators Confirm What Price Is Telling You &nbsp;|&nbsp; 8-Hour Intensive
          </Badge>
        </motion.div>
        ...
        >
          &ldquo;Indicators don&apos;t predict the future. They confirm what price is already telling you.&rdquo;
        </motion.p>
